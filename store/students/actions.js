export default {
    getGrades(vuexContext) {
      ...
      getGroupStudents(vuexContext) {
        return this.$axios.get(`${process.env.OUR_HOST}/groupStudents`).then(res => {
        console.log(res);
      ...
      getSchoolCourses(vuexContext) {
        return this.$axios.get(`${process.env.OUR_HOST}/schoolCourses`).then(res => {
        console.log(res);
      ...
      vuexContext.commit("setStudents", students)
       ...
       addStudent: function(vuexContext, student) {
        this.$axios
          .post("/addStudent", { student: student })
          .then(res => {
